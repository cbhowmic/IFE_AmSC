...
DATA_PATH  = f"{RHINO_PATH}/Power&BurnFractionScan_Day1_Redo" 
INPUT_PATH = f"{DATA_PATH}/{PREFIX}_IFE_input.pkl" #f"{RHINO_PATH}/makeJSON.py" 
...
my_inventory["Tritium"]   = {"data_ss": T_ss, }
...
# HARDCODING THIS FOR NOW BECAUSE MW IS NOT IN THE INPUT FILE 
series.set_attribute("input:MW:Power output in MW", 500)
...
#############################
def write_species(name, data_ss):
